...
export class CompareComponent implements OnInit {
  ...
  public addToCart(product:Product){
    ...
    if(product.cartCount <= product.availibilityCount){
      ...
      this.snackBar.open('You can not add more items than available. In stock ' + product.availibilityCount + ' items and you already added ' + product.cartCount + ' Productos en el carrito', '×', { panelClass: 'error', verticalPosition: 'top', duration: 5000 });
    }
  }
