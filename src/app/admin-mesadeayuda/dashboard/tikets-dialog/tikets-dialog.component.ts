...
@Component({
  selector: 'app-tikets-dialog',
  templateUrl: 'tikets-dialog.component.html',
  styleUrls: ['tikets-dialog.component.scss']
})
export class TiketsDialogComponent implements OnInit {
