...
@Component({
  selector: 'app-carteraporantiguedad',
  templateUrl: './carteraporantiguedad.component.html',
  styleUrls: ['./carteraporantiguedad.component.scss'],
  providers: [NgxSpinnerService, MessagesService]
})
export class CarteraporantiguedadComponent implements OnInit {
  public page: any;
  public count = 50;
  public datCategoria=[];
  public searchText="";
